...
import com.fmi.solarparkapp.config.ProjectCalculatorProvider;
...
public class CustomerService {
    ...
    private ProjectCalculatorProvider projectCalculatorProvider;

    public CustomerService(
            JdbcTemplate jdbcTemplate,
            ProjectCalculatorProvider projectCalculatorProvider
    ) {
        this.jdbcTemplate = jdbcTemplate;
        this.projectCalculatorProvider = projectCalculatorProvider;
    }
    ...
    public boolean createNewCustomer(CustomerModel model) {
        ...
        sb.append(this.projectCalculatorProvider.getNumberOfProjects());
        sb.append(");");
