# Среща 3 -  Създаване на Routing система
 
#### 💡 Какво разгледахме днес
- Как да си заредим, файловете в проекта [КОД](./source/v1);
...
- Какво представляват анотациите в Java и как да етикетираме състоянието на нашите класове[КОД](./source/v3);.
- Актуализиране на текущата версия на нашия HTTP сървър[КОД](./source/v4);
